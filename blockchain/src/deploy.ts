/**
 * Deploy blockchain contract to a Midnight network (undeployed by default; use --network preview|preprod for public networks).
 *
...
const PRIVATE_STATE_ID = 'healthVaultAIPrivateState';
...
const zkConfigPath = path.resolve(__dirname, '..', 'contracts', 'managed', 'HealthVaultAI');
...
const HealthVaultAI = await import(pathToFileURL(contractPath).href);

const compiledContract = CompiledContract.make('HealthVaultAI', HealthVaultAI.Contract).pipe(
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy blockchain to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
