/**
 * CLI for interacting with blockchain contract
 */
...
console.log("exists:", fs.existsSync(contractPath));
console.log("================================");
...
const compiledContract = CompiledContract.make('HealthVaultAI', HelloWorld.Contract).pipe(
...
console.log(Object.keys(deployed));
